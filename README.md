...
**Список специфических флагов:**
* _**-del** – указывает на то, что файлы JSON, формат которых отличается от задонного, необходимо удалить.

**Список специфических ключей:**
* _**--move** – указывает на то, что файлы JSON, формат которых отличается от задонного, необходимо переместить в указанную директорию.
___
```
